...
Begin Historic Route 66 sign (photo, 15m) · Millennium Park / Cloud Gate (45m) · Navy Pier (1h) · 360 Chicago / John Hancock (1h) · Lincoln Park Zoo (free, 1.5h) · Art Institute of Chicago (2–3h) · **United Center + Michael Jordan statue [nba]** · **Bulls team store [nba]** · End Historic Route 66 sign (photo) · New Route 66 Begin sign near Navy Pier (photo) · Chicago River architecture cruise (~10 AM Aug 4, book ahead, meeting point Michigan/Wacker) · The Chicago Theatre (exterior; interior only via guided tour) · Starbucks Reserve Roastery (optional) · Nutella Cafe (optional) · Alice & Wonder – State (souvenirs) · **Hertz Car Rental – West Washington Street (car PICKUP Aug 5 ~9:00)**

> **Rental car (July 2026):** pickup = Hertz "Chicago – West Washington Street" on Aug 5; drop-off = **LAX Rental Car Return Center** on Aug 19 (POI on the Los Angeles city segment). Both are bundled POIs (category `other`).
>
