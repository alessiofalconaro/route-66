...
const en = {
  ...
  categoriesExpenses: 'Expense categories (yours)',
  categoriesPois: 'Stop categories (yours)',
  categoriesNone: 'No custom categories yet — create them from the dropdowns.',
  ...
  // More screen
  moreTitle: 'More',
  albumButton: 'Trip album (phones)',
  campAlbumButton: 'Camp Snap album',
  campAlbumUrl: "Camp Snap album URL (Falco's camera)",
  ...
  syncNews: '↻ Updated with the latest changes from the group',
  backupAll: 'Full backup (all data)',
...
const es: typeof en = {
  ...
  stopPhoto: 'Foto',
  choosePhoto: 'Elegir del teléfono…',
  removePhoto: 'Quitar foto',
  removeConfirm: '¿Quitar esta parada?',
  save: 'Guardar',
  cancel: 'Cancelar',
  pcRoute66: 'Route 66',
  pcNature: 'Naturaleza',
  ...
  categoriesExpenses: 'Categorías de gastos (tuyas)',
  categoriesPois: 'Categorías de paradas (tuyas)',
  categoriesNone: 'Aún no hay categorías personalizadas — créalas desde los desplegables.',
  ...
  moreTitle: 'Más',
  albumButton: 'Álbum del viaje (teléfonos)',
  campAlbumButton: 'Álbum Camp Snap',
  campAlbumUrl: 'URL del álbum Camp Snap (cámara de Falco)',
  ...
  syncNews: '↻ Actualizado con los últimos cambios del grupo',
  backupAll: 'Copia completa (todos los datos)',
